<script lang="ts">
	...
	let showBanner = true;
	const bannerKey = 'shugur-version-banner-v1.3.5';
	...
	<div class="relative isolate flex items-center gap-x-6 overflow-hidden bg-purple-600 px-6 py-2.5 sm:px-3.5 sm:before:flex-1">
		<div class="flex flex-wrap items-center gap-x-4 gap-y-2">
			<p class="text-sm leading-6 text-white">
				<strong class="font-semibold">Shugur Relay v1.3.5</strong>
			...
			<a
				href="https://github.com/Shugur-Network/relay/releases/tag/v1.3.5"
				target="_blank"
