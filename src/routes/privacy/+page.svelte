...
<div class="mx-auto max-w-4xl px-4 py-16">
  ...
  <div class="space-y-8">
    <section>
      ...
      <div class="text-gray-700 leading-relaxed space-y-4">
        <p>
          ...
          or send us an email. This may include your name, email address, company name, and any message content.
        </p>
        <p>
    ...
    <section>
      <h2 class="text-2xl font-bold text-gray-900 mb-4">4. Data Security and Retention</h2>
      <div class="text-gray-700 leading-relaxed space-y-4">
        <p>
    ...
    <section>
      <h2 class="text-2xl font-bold text-gray-900 mb-4">5. Your Rights and Choices</h2>
      <div class="text-gray-700 leading-relaxed space-y-4">
        <p>
